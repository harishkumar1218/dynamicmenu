    ...
    <div>
        <div>
          <CNavbar className="bg-body-tertiary">
            <CContainer fluid>
              <LocationComponent currentLocation="Tirupathi" />
              <CNavbarBrand href="#" style={{ fontFamily: 'Roboto, sans-serif' }} >Main Name</CNavbarBrand>
              ...
              <div>
                <CSidebar ref={sidebarRef} className="border-start show" style={{ backgroundColor: "#ededed" }}>
                  <CSidebarHeader className="border-bottom">
                    <CSidebarBrand>Orian</CSidebarBrand>
                  </CSidebarHeader>
